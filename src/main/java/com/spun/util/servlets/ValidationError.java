...
public class ValidationError extends RuntimeException {
	...
	/***********************************************************************/
	public void setIfValid(String assertion, boolean isError,
			String errorDescription) {
		if (!isOk()) {
			return;
		}
	...
	/***********************************************************************/
	public ValidationError addForRange(String prefix, int startInclusive,
			int endExclusive, ValidationError error) {
	 ...
	 * 
	 * @return The text description of the error or "" if the assertion was
	 *         valid
	 **/
