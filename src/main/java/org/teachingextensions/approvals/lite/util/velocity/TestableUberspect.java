...
public class TestableUberspect implements Uberspect, UberspectLoggable {
  ...
  public static Iterator<?> getStandardIterator(Object obj, Info i) {
    ...
    throw new VelocityParsingError("Could not determine type of iterator in "
        + "#foreach loop ", i);
  }
  ...
  public VelMethod getMethod(Object obj, String methodName, Object[] args,
    ...
    if (obj == null) {
      throw new VelocityParsingError("tried "
          + getMethodText("null", methodName, args), i);
    }
    Method m = introspector.getMethod(obj.getClass(), methodName, args);
    if (m == null) {
      throw new VelocityParsingError("Method "
          + getMethodText(obj.getClass().getName(), methodName, args)
          + " does not exist.", i);
    }
    return new VelMethodImpl(m);
  }

  public static String getMethodText(String className, String methodName,
      Object[] args) {
  ...
  public VelPropertyGet getPropertyGet(Object obj, String identifier, Info i)
    ...
    if (obj == null) {
      throw new VelocityParsingError("tried "
          + getPropertyText("null", identifier), i);
    }
    ...
    if (!executor.isAlive()) {
      // trying isFoo()
      executor = new BooleanPropertyExecutor(log, introspectorWithLog, type,
          identifier);
    }
    if (!executor.isAlive()) {
      throw new VelocityParsingError("Did not find "
