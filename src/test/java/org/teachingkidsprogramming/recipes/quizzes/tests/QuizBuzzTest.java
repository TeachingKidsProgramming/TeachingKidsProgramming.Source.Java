...
public class QuizBuzzTest extends TestCase
{
  public static class BuzzCorrectQuiz extends QuizBuzzAdapter
  {
  ...
  public void testCorrect() throws Exception
  {
    ...
    new QuizBuzzGrader().grade(new BuzzCorrectQuiz());
    TortoiseUtils.verifyForOs();
  }
  public static class BuzzIncorrectQuiz extends QuizBuzzAdapter
  {
    public void question1(String letter1, String letter3)
    {
    }
  ...
  {
    TreeQuizGrader.TURTLE_SPEED = Turtle.TEST_SPEED;
    new QuizBuzzGrader().grade(new BuzzIncorrectQuiz());
    TortoiseUtils.verifyForOs();
  }
}
